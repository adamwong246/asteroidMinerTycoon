...
function backgroundProcess() {
    ReactDOM.render(React.createElement("span", {}, 'hello World from react'), document.getElementById('root'));
    var process = require('child_process'); // The power of Node.JS
    showOS();
    ...
    child.stdout.on('data', function (data) {
        appendOutput(data);
        ReactDOM.render(React.createElement("span", {}, data), document.getElementById('root'));
    });
...
;
//# sourceMappingURL=gui-funct.js.map