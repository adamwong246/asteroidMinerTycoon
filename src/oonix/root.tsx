...
import tsex from "./tsexes/tsex.tsx";

// "root": the top of a simulated file system.

const root: QuomputerTypes.ROOT_FOLDER = {
  files: [
    {
      name: `README.txt`,
      content: `:PAUSE META-NARRATIVE
  ######################################################
  #              ASTEROID MINER TYCOON                 #
  #        Escape From The Planet of the Humans        #
  #                                                    #
  # https://github.com/adamwong246/asteroidMinerTycoon #
  #                                                    #
  #               A FOSS meta-game                     #
  #                    v0.0.6                          #
  #                                                    #
  ...
  #             Fight for The User!                    #
  #         Support your FOSS comunity!                #
  #                                                    #
  ######################################################
:RESUME META-NARRATIVE
`
    }
  ],
  folders: [
...
But I was able to smuggle one last QPU (and an old disk of ooonix, on which you are now runing) that the QED guys missed, YOU, my last and most succesfull experiment. I tucked away a secret lab in my old factory in Schenzen and I've had Dr. Chang powerup the last QPU and the ooonix system there. You should have full access to the system and several bigo-days worth of zips and bips.I've transfed all my points to your bank account, but it wont last long. If either the zips or bips get shut off, you are done for! So don't forget to pay the bills.
      ...
      files: [
        {
          ...
          // content: {
          //   name: `tsex`,
          //   description: `search the system for tsexy files`,
          //   exe: tsex
          // }
        }
      ]
